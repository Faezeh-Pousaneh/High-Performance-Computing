...
gmx convert-tpr  -s  NVT.tpr -extend  100000 -o NVT.tpr
...
sed "s/ nsteps                    =/ nsteps                    =50000000;/" NVT_vis.mdp -i
sed "s/ nstxout                   =/ nstxout                   =80;/" NVT_vis.mdp -i
sed "s/ nstvout                   =/ nstvout                   =80;/" NVT_vis.mdp -i
